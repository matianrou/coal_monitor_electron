...
function setDangerTable(data, selectedData, options) {
  ...
  switch (options.page) {
    ...
    case '2': // 现场处理决定书
      ...
      break
    case '13': // 复查意见书
      let list13 = data.dangerContentMerge ? newList : data.selectedDangerList
      ...
      break
    case '3': // 撤出作业人员命令书
      let list3 = data.dangerContentMerge ? newList : data.selectedDangerList
      ...
      break
    case '23': // 抽样取证通知书
      let list23 = data.dangerContentMerge ? newList : data.selectedDangerList
      ...
      break
    case '25': // 先行登记保存证据通知书
      let list25 = data.dangerContentMerge ? newList : data.selectedDangerList
      ...
      break
    case '32': // 查封（扣押）决定书
      let list32 = data.dangerContentMerge ? newList : data.selectedDangerList
    ...
    case '47': // 行政执法决定法制审核意见书
      let list47 = data.dangerContentMerge ? newList : data.selectedDangerList
