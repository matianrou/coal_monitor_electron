        ...
        <div class="page page-sizeA4">
          <div>
            ...
            <label>政治面貌</label>
                ...
                <span
                  class="line-div"
                  @click="commandFill('cellIdx17', '电话', 'SelectItem')"
            ...
            <label>调查人（签名）：</label>
                ...
                <span
                  ...
                  >{{ letData.cellIdx20 ? letData.cellIdx20 : "" }}</span
                >
            </div>
            <div class="docTextarea">
              <label style="width: 5%"></label>
              <span
                @click="commandFill('cellIdx21', '煤矿概况', 'TextareaItem')"
