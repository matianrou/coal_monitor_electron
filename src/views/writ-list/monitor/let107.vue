          ...
          <div>
            ...
            <div class="docTextLine">
              ...
              <div
                class="line-div"
                @click="
                  commandFill('cellIdx8', '抽样承办人：（签名）', 'TextItem')
                "
              >
            ...
            <!-- <div class="docTextLine">
              <div style="flex: 2; display: flex">
                ...
                <div
                  class="line-div"
                  @click="
                    commandFill('cellIdx20', '抽样时间', 'DateItem')
                  "
                >
                ...
                <div
                  class="line-div"
                  @click="commandFill('cellIdx21', '抽样地点', 'TextItem')"
                >
            ...
            <div class="docTextLine">
              ...
              <div style="flex: 2; display: flex">
                ...
                <div
                  class="line-div"
                  @click="
                    commandFill('cellIdx14', '受送达人（签名）', 'TextItem')
                  "
                >
