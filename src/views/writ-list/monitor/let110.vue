          ...
          <div>
            ...
            <table class="docBody">
              <tr>
                ...
                >{{ letData.cellIdx2 }}</td>
                <td class="textAlignLeft cellBottomLine">{{letData.cellIdx0 && letData.cellIdx0.substring(0, 1)}}〔</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_3"
                  align="center"
            ...
            <table style="border:solid 0 #000;" class="docBody">
              ...
              <tr>
                <td class="textAlignLeft">的规定，根据《中华人民共和国安全生产法》第六十五条第一款第四项规定，我</td>
                <td
                  class="cellInput"
                  id="cell_idx_9"
                  align="center"
                ...
                >{{ letData.cellIdx9 }}</td>
                <td class="textAlignLeft">决定对</td>
              </tr>
              <tr>
                <td class="textAlignLeft">你单位涉案</td>
                <td
                  class="cellInput"
                  id="cell_idx_10"
                  style="width:30%"
              ...
              <tr>
                ...
                <td class="textAlignLeft">申行政复议请</td>
              </tr>
              <tr>
                <td class="textAlignLeft">或6个月内向</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_17"
                  align="center"
