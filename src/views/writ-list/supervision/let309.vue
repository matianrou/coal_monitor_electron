        ...
        <div class="page page-sizeA4">
          <div>
            ...
            <div class="docTextarea">
              ...
              在法定期限内未申请行政复议或者提起行政诉讼。依据《中华人民共和国行政强制法》<span class="text-decoration">五十三</span>条、第<span class="text-decoration">五十四</span>条的规定，请你
              <span
                class="no-underline"
            ...
            <div class="docTextarea">
              <div style="display:inline-block;min-width:55%">
                ...
                <span @click="commandFill('cellIdx26', '联系电话', 'TextItem')">{{
