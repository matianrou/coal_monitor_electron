            ...
            <table class="docBody">
              <tr>
                ...
                <td
                  ...
                  class="cellInput"
                  id="cell_idx_11"
                  @click="commandFill('cellIdx11', '身份证', 'SelectItem')"
              ...
              <tr>
                ...
                <td
                  ...
                  style="width:3%;"
                  class="cellInput"
                  @click="commandFill('cellIdx12', '营业执照', 'SelectItem')"
              ...
              <tr>
                ...
                <td
                  ...
                  style="width:3%;"
                  class="cellInput"
                  @click="commandFill('cellIdx13', '法定代表人身份证明或者委托书', 'SelectItem')"
              ...
              <tr>
                ...
                <td
                  ...
                  id="cell_idx_14"
                  style="width:3%;"
                  @click="commandFill('cellIdx14', '其他', 'SelectItem')"
