          ...
          <div>
            ...
            <table class="docBody">
              <tr>
                ...
                >{{letData.cellIdx1}}</td>
                <td class="textAlignLeft cellBottomLine">送〔</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_2"
                  align="center"
            ...
            <table class="docBody">
              <tr>
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx8', '送达人', 'TextItem')"
                >{{letData.cellIdx8}}</td>
            ...
            <table class="docBody">
              <tr>
                <td class="cellInput" id="cell_idx_13" align="right" style="width:95%">{{letData.cellIdx13}}</td>
              </tr>
            </table>
            <table class="docBody">
