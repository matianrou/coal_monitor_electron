          ...
          <div>
            ...
            <table class="docBody">
              <tr>
                ...
                <td
                  class="cellInput textPaddingLeft cellBottomLine oneLine checkName"
                  id="cell_idx_0"
                  style="width:79%"
                  data-title="被检查单位"
                  data-type="text"
              ...
              <tr>
                ...
                <td
                  class="cellInput cellBottomLine checktime"
                  id="cell_idx_2"
                  style="width:81.3%"
                  data-title="检查时间"
            ...
            <table class="docBody">
              <tr>
                ...
                <td
                  style="width:82%"
                  class="cellInput cellBottomLine oneLine checkAddress"
                  id="cell_idx_4"
                  data-title="检查地点"
                  data-type="text"
