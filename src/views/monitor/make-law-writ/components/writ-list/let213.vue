            ...
            <table style="border:solid 0px #000;" class="docBody">
              ...
              <tr>
                ...
                <div
                  ...
                  data-type="textarea"
                  data-src
                  @click="commandFill('cellIdx0', '承办人意见', 'TextareaItem')">
                  <p class="show-area-item-p">
                    <span style="padding: 7px;">{{ letData.cellIdx0 }}</span>
                  </p>
                </div>
              ...
              <tr>
                ...
                <div
                  ...
                  data-type="textarea"
                  data-src
                  @click="commandFill('cellIdx5', '审批人意见', 'TextareaItem')">
                  <p class="show-area-item-p">
...
import { getDangerObject, corpInformation } from '@/utils/monitor/setInitPaperData'
export default {
  name: "Let213",
  props: {
    corpData: {
