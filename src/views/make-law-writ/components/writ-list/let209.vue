      ...
      <div slot="left">
        <div class="page page-sizeA4">
          <div>
            ...
            <table style="border:solid 0px #000;" class="docBody">
              ...
              <tr>
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx13', '地点', 'TextItem')"
            ...
            <table class="docBody">
              ...
              <tr>
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx29', '地址', 'TextItem')"
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx30', '邮政编码', 'TextItem')"
              ...
              <tr>
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx31', '单位', 'TextItem')"
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx32', '联系人', 'TextItem')"
                ...
                <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx33', '联系电话', 'TextItem')"
            ...
            <table class="docBody">
              <tr>
                <td class="cellInput" id="cell_idx_34" align="right" style="width:95%">{{letData.cellIdx34}}</td>
              </tr>
            </table>
            <table class="docBody">
              ...
              <td
                ...
                data-type="text"
                data-src
                @click="commandFill('cellIdx35', '年', 'TextItem')"
              ...
              <td
                ...
                data-type="text"
                data-src
                @click="commandFill('cellIdx36', '月', 'TextItem')"
              ...
              <td
                ...
                data-type="text"
                data-src
                @click="commandFill('cellIdx37', '日', 'TextItem')"
            ...
            <table class="docBody">
              ...
              <td class="cellInput" id="cell_idx_38" align="center" style="width:8%">{{letData.cellIdx38}}</td>
