        ...
        <div class="page page-sizeA4">
          <div>
            ...
            <table class="docBody">
              ...
              <tr>
                ...
                <td
                  ...
                  data-type="textarea"
                  data-src
                  @click="commandFill('cellIdx4', '案由', 'TextItem')"
                >{{letData.cellIdx4}}</td>
            ...
            <div
              ...
              data-type="textarea"
              data-src
              @click="commandFill('cellIdx9', '行政复议决定', 'TextareaItem')">
            ...
            <table class="docBody">
              <tr>
                <td class="cellInput" id="cell_idx_11" align="right" style="width:95%">{{letData.cellIdx11}}</td>
              </tr>
            </table>
            <table class="docBody">
