    ...
    <div class="let-main-right" id="toolContainer">
      ...
      >
        <tr>
          ...
          <td v-if="docData.docTypeNo !== '44' && docData.docTypeNo !== '21' && docData.docTypeNo !== '43' && docData.docTypeNo !== '45'" style="width:100px;text-align:center;cursor: pointer;" @click="cmdDocView" >
