    ...
    <div class="let-main-right" id="toolContainer" :style="fromPage === 'writ-case' ? 'height: calc(100vh - 200px)' : ''">
      ...
      >
        <tr>
          ...
          <td v-if="showPrintBtn" style="width:100px;text-align:center;cursor: pointer;" @click="exportTemplate" >
  ...
  computed: {
    ...
    showPrintBtn () {
      ...
      if (this.$store.state.user.userType === 'supervision') {
        ...
        if (docTypeNo === '44' || docTypeNo === '21' || docTypeNo === '43' || docTypeNo === '45') {
          show = false
        } else {
          show = true
        }
  ...
  methods: {
    ...
    async exportTemplate () {
      ...
      if (this.docData.docTypeNo === '22' || this.docData.docTypeNo === '42') {
        ...
        || (this.docData.docTypeNo === '46' && this.$store.state.user.userType === 'supervision')) {
      ...
      if(this.docData.docTypeNo === '32' || this.docData.docTypeNo === '34' || this.docData.docTypeNo === '37' || this.docData.docTypeNo === '38'
        ...
        || this.docData.docTypeNo === '41' || this.docData.docTypeNo === '12' || (this.docData.docTypeNo === '29' && this.$store.state.user.userType !== 'supervision')
        || (this.docData.docTypeNo === '47' && this.$store.state.user.userType !== 'supervision') || (this.docData.docTypeNo === '52' && this.$store.state.user.userType !== 'supervision') 
        || (this.docData.docTypeNo === '54' && this.$store.state.user.userType !== 'supervision')) {
