...
<template>
  <div class="let-main">
    ...
    <div class="let-main-right" id="toolContainer">
      ...
      >
        <tr>
          <td style="width:100px;text-align:center; cursor: pointer; " @click="cmdDocSave('2')" :disabled="!canEdit">
            ...
            <span style="color: #409EFF; display:inline-block;font-size:14px;font-weight: bold;"> 保 存</span>
          </td>
          <td style="width:100px;text-align:center;cursor: pointer;"    @click="cmdDocView" >
            ...
            <span style="color: #409EFF; display:inline-block;font-size:14px;margin-top:5px;font-weight: bold;"> 打印预览</span>
            <!-- <a class="btnTool" href="javascript:cmdDocView()">打印预览</a> -->
          </td>
          <td style="width:100px;text-align:center;cursor: pointer;" :disabled="!canEdit" @click="cmdDocSave('0')">
            ...
            <span style="color: #409EFF; display:inline-block;font-size:14px;font-weight: bold;"> 归 档</span>
          ...
          <td style="width:100px;text-align:center;cursor: pointer;" @click="cmdDocBack">
            ...
            <span style="color: #409EFF; display:inline-block;font-size:14px;font-weight: bold;"> 返 回</span>
