      ...
      >
        <tr>
          <td style="width:100px;text-align:center; cursor: pointer; " @click="cmdDocSave('2')" :disabled="!canEdit">
            ...
            <span style="color: #000; display:inline-block;font-size:14px"> 保 存</span>
          </td>
          <td style="width:100px;text-align:center;cursor: pointer;"    @click="cmdDocView" >
            ...
            <span style="color: #000; display:inline-block;font-size:14px;margin-top:5px "> 打印预览</span>
          ...
          <td style="width:100px;text-align:center;cursor: pointer;" :disabled="!canEdit" @click="cmdDocSave('0')">
            ...
            <span style="color: #000; display:inline-block;font-size:14px"> 归 档</span>
          ...
          <td style="width:100px;text-align:center;cursor: pointer;" @click="cmdDocBack">
            ...
            <span style="color: #000; display:inline-block;font-size:14px"> 返 回</span>
