          ...
          <div>
            ...
            <table style="border:solid 0px #000;" class="docBody">
              <tr>
                ...
                <!-- <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx9', '违法违规行为', 'DangerTableItem')"
                >{{ letData.cellIdx9 }}</td> -->
                <div
                ...
                <td class="textAlignLeft">的违法违规行为，依法作出了</td>
                <!-- <td
                  style="width:69.2%"
                  class="cellInput cellBottomLine"
                  id="cell_idx_10"
                ...
                <div
                  ...
                  data-type="textarea"
                  data-src
                  @click="commandFill('cellIdx10', '现场处理决定', 'DangerTableItem')">
              ...
              <tr>
                ...
                <td style="width:5%"></td>
                <td class="textAlignLeft">应你单位申请，经复查，意见如下：</td>
              </tr>
              <tr></tr>
            </table>
            <div
              ...
              data-type="textarea"
              data-src
              @click="commandFill('cellIdx11', '意见', 'TextareaItem')"
            >
              <p
            ...
            <table class="docBody">
              <tr>
                ...
                <td class="textAlignLeft">现场执法人员（签名):</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_12"
                  align="center"
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx12', '现场执法人员（签名)', 'TextItem')"
                >{{letData.cellIdx12}}</td>
                ...
                <td
                  ...
                  data-type="date"
                  data-src
                  @click="commandFill('cellIdx13', '执法证号', 'TextItem')"
                >{{letData.cellIdx13}}</td>
                <td style="width:21%"></td>
                 <td
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx14', '现场执法人员（签名)', 'TextItem')"
                >{{letData.cellIdx14}}</td>
                <td class="textAlignCenter">执法证号：</td>
                <td
                  class="cellInput cellBottomLine"
                  ...
                  data-type="date"
                  data-src
                  @click="commandFill('cellIdx15', '执法证号', 'TextItem')"
                >{{letData.cellIdx15}}</td>
              </tr>
              <tr>
                
                <td class="textAlignLeft">被检查单位意见：</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_16"
                  align="center"
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx16', '被检查单位意见', 'TextItem')"
                >{{letData.cellIdx16}}</td>
                <td class="textAlignLeft">单位负责人（签名）：</td>
                <td
                  class="cellInput cellBottomLine"
                  id="cell_idx_17"
                  align="center"
                  ...
                  data-type="text"
                  data-src
                  @click="commandFill('cellIdx17', '单位负责人（签名)', 'TextItem')"
  ...
  methods: {
    async initData() {
      ...
      if (checkPaper.length > 0) {
        ...
        // 3.现场处理决定2的文书号：11-14
        let paperNum2 = await getDocNumber(db, '2', caseId, this.$store.state.user)
        this.letData = {
          cellIdx0: num0, // 文书号
          ...
          cellIdx11: paperNum2.num0, // 文书号
          cellIdx11TypeTextItem: paperNum2.num0, // 文书号
          cellIdx12: paperNum2.num1, // 文书号
          cellIdx12TypeTextItem: paperNum2.num1, // 文书号
          cellIdx13: paperNum2.num3, // 文书号
          cellIdx13TypeTextItem: paperNum2.num3, // 文书号
          cellIdx14: paperNum2.num4, // 文书号
          cellIdx14TypeTextItem: paperNum2.num4, // 文书号
          cellIdx15: null,
          cellIdx16: null, // 意见
