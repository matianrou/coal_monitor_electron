...
} from "@/utils/supervision/handlePaperData";
  ...
  methods: {
    ...
    async saveToUpload(paperId) {
      ...
      if (this.docData.docTypeNo === "22") {
        ...
        let p22PaperData = {
          p22BeginTime:
            letData.cellIdx2TypeDaterangeItem && letData.cellIdx2TypeDaterangeItem.length > 0 ? letData.cellIdx2TypeDaterangeItem[0]
              .replace("年", "-")
              .replace("月", "-")
              .replace("日", "") + " 00:00:00" : null,
          p22EndTime:
            letData.cellIdx2TypeDaterangeItem && letData.cellIdx2TypeDaterangeItem.length > 1 ? letData.cellIdx2TypeDaterangeItem[1]
              .replace("年", "-")
              .replace("月", "-")
              .replace("日", "") + " 00:00:00" : null,
