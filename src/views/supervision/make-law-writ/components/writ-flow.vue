              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let100','检查方案', '2')" class="flow-span">检查方案</span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let102','现场处理决定书', '4')" class="flow-span">
                    现场处理
                    <br />决定书
                  </span>
                </td>
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let106','责令撤出作业人员命令书', '14')" class="flow-span">
                    责令撤出作业人员
                    <br />命令书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd">
                  <img
                    v-if="flowStatus.paper16"
                    :src="require(flowStatus.paper16 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper16 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let108','先行登记保存证据通知书', '16')" class="flow-span">
                    先行登记保存证据
                    <br />通知书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    v-if="flowStatus.paper17"
                    :src="require(flowStatus.paper17 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper17 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let109','先行登记保存证据处理决定书', '17')" class="flow-span">
                    先行登记保存证据
                    <br />处理决定书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let110','查封(扣押)决定书', '18')" class="flow-span">
                    查封(扣押)
                    <br />决定书
                  </span>
                </td>
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let110','延长查封（扣押）期限决定书', '18')" class="flow-span">
                    延长查封（扣押）
                    <br />期限决定书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let110','查封(扣押)处理决定书', '18')" class="flow-span">
                    查封(扣押)处理
                    <br />决定书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let111','停供电(停供民用爆炸物品)决定书', '19')" class="flow-span">
                    停供电(停供民用
                    <br />爆炸物品)决定书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let112','停供电(停供民用爆炸物品)函告书', '20')" class="flow-span">
                    停供电(停供民用
                    <br />爆炸物品)函告书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    :src="require(flowStatus.paper21 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper21 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let113','解除停供电(停供民用爆炸物品)通知书', '21')" class="flow-span">
                    解除停供电(停供民用
                    <br />爆炸物品)函告书
                  </span>
                </td>
          ...
          <div v-else-if="activeFlowTab === 'flow-2'" style="padding:16px;">
              ...
              <tr>
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let202','调查询问笔录', '23')" class="flow-span">调查询问笔录</span>
                </td>
                <td style="width:28px;">
                  <img src="../assets/image/doc-flow_r1_c5.png" style="height: 65px;" />
                </td>
                <td class="writ-flow-spantd">
                  <img
                    v-if="flowStatus.paper24"
                    :src="require(flowStatus.paper24 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper24 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let203','行政执法决定法制审核意见书', '24')" class="flow-span">
                    行政执法决定法制
                    <br />审核意见书
                  </span>
                </td>
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let204','集体讨论记录', '25')" class="flow-span">集体讨论记录</span>
                </td>
                <td style="width:12px;">
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let206','行政处罚决定书', '27')" class="flow-span">
                    行政处罚决定书
                  </span>
                </td>
                <td style="width:28px;">
            ...
            <table style="width: 1046px;height:65px;border-collapse: collapse;">
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    v-if="flowStatus.paper26"
                    :src="require(flowStatus.paper26 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper26 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let205','询问通知书', '26')" class="flow-span">
                    询问通知书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let209','听证通知书', '30')" class="flow-span">
                    听证通知书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    :src="require(flowStatus.paper31 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper31 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let210','不予受理听证申请通知书', '31')" class="flow-span">
                    不予受理听证<br />申请通知书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let211','听证笔录', '32')" class="flow-span">
                    听证笔录
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let211','听证会报告书', '32')" class="flow-span">
                    听证会报告书
                  </span>
                </td>
                <td style="width:12px;">
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let212','罚款缴纳催告书', '')" class="flow-span">
                    罚款缴纳催告书?
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let213','加处罚款决定书', '34')" class="flow-span">
                    加处罚款决定书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let213','延期（分期）缴纳罚款决定书', '34')" class="flow-span">
                    延期（分期）缴纳<br />罚款决定书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let213','案件结案报告', '34')" class="flow-span">
                    案件结案报告
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    :src="require(flowStatus.paper35 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper35 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let214','执法案卷（首页）及目录', '35')" class="flow-span">
                    执法案卷（首页）<br />及目录
                  </span>
                </td>
                <td style="width:12px;">
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    alt
                  />
                  <span @click="cmdEditDoc('let302','行政强制执行事先催告书', '38')" class="flow-span">
                    行政强制执行<br />事先催告书
                  </span>
                </td>
                <td style="width:28px;">
                ...
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    :src="require(flowStatus.paper39 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                ...
                <td class="writ-flow-spantd">
                  <img
                    v-if="flowStatus.paper40"
                    :src="require(flowStatus.paper40 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper40 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let304','行政执法有关事项审批报告', '40')" class="flow-span">
                    行政执法有关事项<br />审批报告
                  </span>
                </td>
                <td style="width:12px;">
              ...
              <tr>
                ...
                <td class="writ-flow-spantd">
                  <img
                    ...
                    :src="require(flowStatus.paper42 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper42 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let401','移送书', '42')" class="flow-span">移送书</span>
                </td>
                <td style="width:28px;">
                  <img src="../assets/image/doc-flow_r1_c3.png" style="height: 65px;" />
                </td>
                <td class="writ-flow-spantd-ex">
                  <img
                    ...
                    :src="require(flowStatus.paper43 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper43 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let402','涉嫌犯罪案件移送书', '43')" class="flow-span">涉嫌犯罪案件<br />移送书</span>
                </td>
                <td style="width:28px;">
                  <img src="../assets/image/doc-flow_r1_c5.png" style="height: 65px;" />
                </td>
                <td class="writ-flow-spantd">
                  <img
                    ...
                    :src="require(flowStatus.paper44 === 'save' ? '../assets/image/save.png' : '../assets/image/file.png')"
                    :title="flowStatus.paper44 === 'save' ? '已保存' : '已归档'"
                    alt
                  />
                  <span @click="cmdEditDoc('let402','鉴定委托书', '44')" class="flow-span">
                    鉴定委托书
                  </span>
                </td>
